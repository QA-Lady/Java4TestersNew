...
public class JamesHelper {
    ...
    public JamesHelper(AppManager appManager) {
    ...
    private void initTelnetSession() {
        mailserver = appManager.getProperty("mailserver.host");
        int port = Integer.parseInt(appManager.getProperty("mailserver.port"));
        String login = appManager.getProperty("mailserver.adminlogin");
        String password = appManager.getProperty("mailserver.adminpassword");
        ...
        //it doesn't allow to login on the first attempt
        readUntil("Login id:");
        write("");
        readUntil("Password:");
        write("");
